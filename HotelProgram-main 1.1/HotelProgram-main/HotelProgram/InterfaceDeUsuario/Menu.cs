...
public class Menu
{
    public static string Exibir()
    {
        ...
        System.Console.WriteLine("7. Pesquisar hospede cadastrado por CPF ou nome.");
        System.Console.WriteLine("8. Exibir reservas.");
        System.Console.WriteLine("9. Exibir Checkins.");
        System.Console.WriteLine("10. Exibir Checkouts.");
